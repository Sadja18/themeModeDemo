...
class StepperLinear extends StatefulWidget {
  const StepperLinear({super.key});

  @override
  State<StepperLinear> createState() => _StepperLinearState();
}

class _StepperLinearState extends State<StepperLinear> {
  int _currentStep = 0;
